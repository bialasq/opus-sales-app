      ...
      <nav class="flex flex-1 flex-col gap-0.5 overflow-y-auto p-3 pb-6">
        <template v-for="item in visibleNavItems" :key="item.to">
          ...
          <RouterLink
            ...
            :class="
              isActive(item.to)
                ? 'bg-indigo-50 text-indigo-700 ring-1 ring-indigo-100 dark:bg-indigo-950 dark:text-indigo-300 dark:ring-indigo-900'
                : ''
            "
            @click="closeNavMobile"
          >
            <span
              class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-600 transition-colors group-hover:bg-white group-hover:text-indigo-600 dark:bg-slate-800 dark:text-slate-300 dark:group-hover:bg-slate-700"
              :class="
                isActive(item.to)
                  ? 'bg-white text-indigo-600 shadow-sm ring-1 ring-indigo-100 dark:bg-slate-800 dark:text-indigo-300 dark:ring-indigo-900'
                  : ''
              "
            >
      ...
      >
        ...
        >
          ...
          <a
            ...
            class="inline-flex items-center gap-1.5 rounded-full border border-indigo-200/80 bg-indigo-50/80 px-3 py-1 text-xs font-medium text-indigo-700 transition-colors hover:border-indigo-300 hover:bg-indigo-100 dark:border-indigo-900 dark:bg-indigo-950 dark:text-indigo-300"
          >
